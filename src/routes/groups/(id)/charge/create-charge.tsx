...
const CreateChargeSchema = z.object({
    ...
    currency: z
        .string()
        .min(1, "why it so short?")
        .max(10, "Why is it so long?"),
});
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormDescription>
                            You can give the charge a name, or it will be
        ...
        if (!isSelected) {
            ...
            if (formValues.splitType == "equal") {
                ...
                const split =
                    remaining.length == 0
                        ? 0
                        : formValues.price / remaining.length;
                form.setValue(
                    "split",
                        ...
                        >
                            {isSelected && (
                                <NumberFormatInput
                                    ...
                                    disabled={
                                        !isSelected ||
                                        form.getValues().splitType == "equal"
                                    }
